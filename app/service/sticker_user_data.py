...
class StickerUserDataService:
    ...
    def __init__(self, box_repo: StickerUserDataRepository,
    ...
    async def save_box_sticker_user_data(
        self, template_data: BoxStickerTemplateView
    ) -> None:  #TODO: не сохраняет offset и limit
    ...
    async def save_unit_sticker_user_data(
            self, template_data: IndividualStickerTemplateView) -> None:
