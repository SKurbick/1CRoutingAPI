...
class LocalisationService:
    ...
    async def save_localisations(
        ...
        None
    ):  # template_data: BoxStickerTemplateView #TODO: сделать универсальный метод для всех видо стикеров(сохранять локлизацию для товара, а не для стикера) #TODO: добавить сохранение русских записей
