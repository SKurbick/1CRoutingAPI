                ...
                async with conn.transaction():
                    ...
                    for doc_data in data:
                        for supply_data in doc_data.supply_data:
                            ...
                            receipt_transaction_number, comment, actual_quantity, unit_price, last_purchase_supplier, last_purchase_price, cancelled_due_to,planned_cost, vehicle_number, truck_number)
