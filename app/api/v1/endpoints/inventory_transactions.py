...
from app.models.inventory_transactions import ITGroupData, group_data_response_example, InventoryTransactionsResponse, AddStockByClientGroupData, \
    add_stock_by_client_response_example, KitOperationsData, kit_operations_response_example, IncomingReturnsData, incoming_returns_response_example, \
    ReSortingOperationData, re_sorting_operations_response_example
...
#
#
# @router.get("/get_kit_operations", response_model=List[KitOperationsData] | InventoryTransactionsResponse, status_code=status.HTTP_200_OK,
