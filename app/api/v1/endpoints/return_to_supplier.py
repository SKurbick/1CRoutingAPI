...
_example_data = [
    {
        "supply_date": "2026-04-07T10:00:00",
        ...
        "update_document_datetime": "2026-04-07T10:00:00",
...
async def update_return_to_supplier(
    ...
    Алгоритм:
    1. По guid инвалидируем существующую запись (is_valid = FALSE)
    2. Вставляем новый заголовок документа
    3. Вставляем позиции документа
    """
